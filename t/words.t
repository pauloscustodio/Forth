...
forth_ok("words", <<'END');
/STRING SET-PRECISION PRECISION F~ FTRUNC FSQRT FLNP1 FEXPM1 FLN FEXP FALOG
FLOG FSINCOS FATAN2 FATANH FACOSH FASINH FATAN FACOS FASIN FTANH FCOSH FSINH
FTAN FCOS FSIN FABS F>S S>F FS. FE. F. F** REPRESENT FROUND FNEGATE FMIN FMAX
FLOOR SFLOATS SFLOAT+ DFLOATS DFLOAT+ FLOATS FLOAT+ FDEPTH -FROT FROT FOVER
FDUP FSWAP FDROP SFALIGNED SFALIGN DFALIGNED DFALIGN FALIGNED FALIGN F0>= F0<=
F0> F0< F0<> F0= F>= F<= F> F< F<> F= F/ F- F* F+ SF@ SF! DF@ DF! F@ F! F>D D>F
