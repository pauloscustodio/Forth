...
forth_ok("words", <<'END');
INCLUDED TIME&DATE MS K-F12 K-F11 K-F10 K-F9 K-F8 K-F7 K-F6 K-F5 K-F4 K-F3 K-F2
K-F1 K-NEXT K-PRIOR K-DELETE K-INSERT K-END K-HOME K-RIGHT K-LEFT K-DOWN K-UP
K-SHIFT-MASK K-CTRL-MASK K-ALT-MASK EMIT? EKEY>FKEY EKEY>CHAR EKEY EKEY? KEY
KEY? END-STRUCTURE 2FIELD: FIELD: CFIELD: +FIELD BEGIN-STRUCTURE PAGE AT-XY
ABORT" ABORT CATCH THROW DNEGATE DMIN DMAX DABS D>S D0>= D0> D0<= D0< D0<> D0=
DU>= DU> DU<= DU< D>= D> D<= D< D<> D= M+ M*/ D2/ D2* D- D+ 2LITERAL 2VARIABLE
2CONSTANT OFF ON SEE DUMP ENVIRONMENT? WORDS .RS .S THRU LIST UPDATE LOAD FLUSH
...
DOES> LITERAL CONSTANT TO 2VALUE VALUE BUFFER: VARIABLE CREATE ['] ' ] [ ;
