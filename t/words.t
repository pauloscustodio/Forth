...
D. . #> SIGN HOLD #S # <# SPACES SPACE CR EMIT TYPE RESTORE-INPUT SAVE-INPUT
...
2@ 2! C@ C! +! @ ! RSHIFT LSHIFT INVERT XOR OR AND 0>= 0<= 0> 0< 0<> 0= U>= U<=
U> U< >= <= > < <> = WITHIN CELLS CELL+ CHARS CHAR+ MIN MAX ABS UM* S>D NEGATE
2/ 2* 1- 1+ M* SM/REM UM/MOD FM/MOD */MOD */ /MOD MOD / - * + HEX DECIMAL BASE
TRUE FALSE PAD BL
END
