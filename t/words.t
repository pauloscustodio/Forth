...
forth_ok("words", <<'END');
/STRING {: LOCALS| (LOCAL) SET-PRECISION PRECISION F~ FTRUNC FSQRT FLNP1 FEXPM1
FLN FEXP FALOG FLOG FSINCOS FATAN2 FATANH FACOSH FASINH FATAN FACOS FASIN FTANH
FCOSH FSINH FTAN FCOS FSIN FABS F>S S>F FS. FE. F. F** REPRESENT FROUND FNEGATE
FMIN FMAX FLOOR SFLOATS SFLOAT+ DFLOATS DFLOAT+ FLOATS FLOAT+ FDEPTH -FROT FROT
...
D2* D- D+ 2LITERAL 2VARIABLE 2CONSTANT OFF ON SEE DUMP ENVIRONMENT? WORDS .FS
...
DEFER [COMPILE] COMPILE, IMMEDIATE POSTPONE DOES> LITERAL CONSTANT TO FVALUE
