...
forth_ok("words", <<'END');
INCLUDED DNEGATE DMIN DMAX DABS D>S D0>= D0> D0<= D0< D0<> D0= DU>= DU> DU<=
...
SAVE-BUFFERS BUFFER BLOCK SCR BLK ABORT" ABORT BYE QUIT ENDCASE ENDOF OF CASE
...
QUERY EXPECT SPAN KEY ACCEPT REFILL SOURCE-ID #TIB TIB SOURCE #IN >IN .( C" S\"
S" ." COUNT CONVERT >NUMBER NUMBER NUMBER? DPL [CHAR] CHAR PARSE-NAME
