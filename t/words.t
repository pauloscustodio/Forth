...
forth_ok("words", <<'END');
/STRING FABS REPRESENT FROUND FNEGATE FMIN FMAX FLOOR FLOATS FLOAT+ FDEPTH
-FROT FROT FOVER FDUP FSWAP FDROP FALIGNED FALIGN F0>= F0<= F0> F0< F0<> F0=
F>= F<= F> F< F<> F= F/ F- F* F+ F@ F! F>D D>F >FLOAT FVARIABLE FCONSTANT
...
WORDS .FS .RS .S THRU LIST UPDATE LOAD FLUSH EMPTY-BUFFERS SAVE-BUFFERS BUFFER
