...
#define QUERY_ENV(env, action)  \
    ...
    QUERY_ENV("BLOCK", push(F_TRUE); push(F_TRUE))
    QUERY_ENV("BLOCK-EXT", push(F_TRUE); push(F_TRUE))
    QUERY_ENV("DOUBLE", push(F_TRUE); push(F_TRUE))
    QUERY_ENV("DOUBLE-EXT", push(F_TRUE); push(F_TRUE))
