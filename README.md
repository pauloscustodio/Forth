...
TOOLS EXT:
    AHEAD BYE CS-PICK CS-ROLL N>R NR> STATE
  Missing:
    ;CODE ASSEMBLER CODE EDITOR FORGET NAME>COMPILE NAME>INTERPRET
    NAME>STRING SYNONYM TRAVERSE-WORDLIST [DEFINED] [ELSE] [IF] [THEN]
    [UNDEFINED]
