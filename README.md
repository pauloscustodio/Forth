...
CORE EXT:
  Implemented:
    .( .R 0<> 0> 2>R 2R> 2R@ :NONAME <> ?DO ACTION-OF AGAIN C" CASE
    COMPILE, DEFER DEFER! DEFER@ ENDCASE ENDOF ERASE FALSE HEX IS MARKER
    NIP OF PAD PARSE PARSE-NAME PICK REFILL RESTORE-INPUT ROLL SAVE-INPUT
