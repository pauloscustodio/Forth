...
CORE EXT:
  Implemented:
    ...
    ENDOF ERASE FALSE HEX MARKER NIP OF PAD PARSE PICK REFILL RESTORE-INPUT
    ROLL SAVE-INPUT SOURCE-ID TO TRUE TUCK U.R U> UNUSED VALUE WITHIN
    [COMPILE] \
  Missing:
    ACTION-OF BUFFER: DEFER DEFER! DEFER@ HOLDS IS PARSE-NAME S\"
